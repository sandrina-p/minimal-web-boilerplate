...
exports.logWorld = logWorld;
exports.logSquare = logSquare;
// -------------------------------------------------
// You can just delete all of this and start coding!
// -------------------------------------------------

function logWorld(name) {
  console.log(`Wello ${name}!`);
  return `Wello ${name}!`;
}

function logSquare(value) {
...
if (!module.bundle.parent && typeof WebSocket !== 'undefined') {
  var ws = new WebSocket('ws://' + window.location.hostname + ':51557/');
